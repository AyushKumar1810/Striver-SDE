...
#NOTE : use sets then sort the array(if array is not sorted) then just return it with using .join  function Like array.join('_')

#NOTE : for better approach go for the two pointer approach 
